<div>
    ...
    <section class="relative min-h-[40vh] flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-900 to-blue-900/30 pt-20">
    ...
    <section class="py-16 bg-slate-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- Back Button --}}
            <div class="mt-8">
                <a href="{{ route('home') }}#berita" class="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors">
                        ...
                        <a href="{{ route('post.show', $relatedPost->slug) }}" 
                           class="group glass rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all">
                            ...
                            <div class="p-6">
                                ...
                                <h3 class="text-white font-semibold mb-2 group-hover:text-blue-400 transition-colors line-clamp-2">
                                    {{ $relatedPost->title }}
                                </h3>
                            </div>
                        </a>
